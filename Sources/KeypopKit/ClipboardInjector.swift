...
/// Marks events generated by KeyPop so they cannot feed the matcher.
enum KeypopSyntheticEvent {
    static let userData: Int64 = 0x4B505F4B4559
}
...
public struct ClipboardInjector: Sendable {
    ...
    private func markAsSynthetic(_ event: CGEvent) {
        event.setIntegerValueField(.eventSourceUserData, value: KeypopSyntheticEvent.userData)
    }
